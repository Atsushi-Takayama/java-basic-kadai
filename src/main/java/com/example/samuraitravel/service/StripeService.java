   ...
   public String createStripeSession(String houseName, ReservationRegisterForm reservationRegisterForm, HttpServletRequest httpServletRequest) {
	   ...
	   SessionCreateParams params = 
			   ...
			   .addPaymentMethodType(SessionCreateParams.PaymentMethodType.CARD)
			                    ...
			                    .setSuccessUrl(requestUrl.replaceAll("/houses/[0-9]+/reservations/confirm", "").replaceAll("/reservations/confirm", "") + "/reservations?reserved")
			                    .setCancelUrl(requestUrl.replaceAll("/reservations/confirm", ""))
